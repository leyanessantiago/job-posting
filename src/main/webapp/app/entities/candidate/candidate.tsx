...
export type ICandidateState = IPaginationBaseState;

export class Candidate extends React.Component<ICandidateProps, ICandidateState> {
  ...
  render() {
    const { candidateList, match, totalItems } = this.props;
    return (
      <div>
