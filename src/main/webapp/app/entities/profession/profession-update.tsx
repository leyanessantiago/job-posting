...
export class ProfessionUpdate extends React.Component<IProfessionUpdateProps, IProfessionUpdateState> {
  ...
  render() {
    const { professionEntity, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="jobpostingApp.profession.home.createOrEditLabel">Create or edit a Profession</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : professionEntity} onSubmit={this.saveEntity}>
                {!isNew ? (
                  <AvGroup>
                    <Label for="profession-id">ID</Label>
