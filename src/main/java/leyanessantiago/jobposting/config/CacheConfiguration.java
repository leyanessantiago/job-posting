...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, leyanessantiago.jobposting.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, leyanessantiago.jobposting.repository.UserRepository.USERS_BY_EMAIL_CACHE);
